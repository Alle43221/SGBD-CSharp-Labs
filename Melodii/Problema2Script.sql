...
drop index IndexTitluAnlansare on Melodii;
create index IndexTitluAnlansare on Melodii(an_lansare, titlu);

select titlu from melodii order by an_lansare;
select titlu from melodii where an_lansare='2002';
